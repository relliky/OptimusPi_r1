...
void I2CTestClass::runBasicWriteTest(void)
{
	...
	I2CClass_0.writeBits8(MPU9150_ADDRESS_AD0_LOW, MPU9150_RA_INT_PIN_CFG, 6, 2, TP_WBits_data);
	//read back and check if bit 5 and bit 6 are written as 0b11
	I2CClass_0.readRegisters8(MPU9150_ADDRESS_AD0_LOW, MPU9150_RA_INT_PIN_CFG, &TP_WBits_data_read, 1);
