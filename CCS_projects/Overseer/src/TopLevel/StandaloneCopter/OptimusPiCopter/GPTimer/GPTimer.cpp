...
// The acutal ControlClass is fully defined later in the .cpp file.
...
float GPTimerClass::getSystemUpdateRateDt()
{
	return dt;
}

// dt cannot be greater than 53.68s, otherwise loadval would overflow.
void GPTimerClass::setSystemUpdateRateDt(float dt_set)
{
	dt = dt_set;
