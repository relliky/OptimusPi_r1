...
float ControlClass::getSystemUpdateRateDt()
{
	return timer.getSystemUpdateRateDt();
}

void ControlClass::setSystemUpdateRateDt(float dt_set)
{
	timer.setSystemUpdateRateDt(dt_set);
}
