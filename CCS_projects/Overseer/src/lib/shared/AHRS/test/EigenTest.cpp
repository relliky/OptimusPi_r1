...
void EigenTestClass::runEigenTests()
{
    ...
    std::cout << TestMatrixZero.Zero() << std::endl;
    ...
    // STOP TO VERIFY EIGEN CLASS AND USE ANOTHER METHOD TO VERIFY IT
    printf("!!!!!!!!!N.B. NOT VERIFYING AHRS CLASS BY JUST USING EIGEN LIBRARY SOLOLY. VARIFYING AHRS USING RASPBERRY PI TO PRODUCE REFERENCE TEST RESULTS. \n");
