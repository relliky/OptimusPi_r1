...
MessageParserClass::MessageParserClass()
{
	...
	// switching-mode commands
	commandInfo[OVERSEER_CONFIG_AS_STANDALONE_COPTER]   = (commandInfo_s){0, 	write, 	0};
	commandInfo[OVERSEER_CONFIG_AS_PI_CONTROLLED_COPTER]= (commandInfo_s){0, 	write, 	0};
#endif
