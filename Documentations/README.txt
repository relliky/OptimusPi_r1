1. [WORKING FOR CROSS COMPILATION, BUT NOT WORKING FOR REMOTE DEBUG] See tutorial below to set up windows eclipse in windows to compile c/c++ project for Raspberry Pi
...
2. [WORKING FOR CROSS COMPILATION, BUT NOT WORKING FOR REMOTE DEBUG] Windows Eclipse project setting for compilation and debug
...
4. Setting up Linux I2C library to support C++
...
Ex. Compiling Raspberry Pi project on a pi (Extremly slow but definitely work)

	http://linuxtortures.blogspot.it/2012/06/cross-compiling-and-cross-debugging-c.html

Ex2. Direct Network Connection between Windows PC and Raspberry Pi using Erthernet Cable
	
	http://www.instructables.com/id/Direct-Network-Connection-between-Windows-PC-and-R/

Ex3. Raspberry Pi Internet Access with an Erthnet Cable direct connected to the laptop
